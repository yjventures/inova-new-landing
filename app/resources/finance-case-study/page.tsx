        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            {[
              ...
              <div key={i} className="bg-slate-800 p-6 rounded-xl shadow-lg border border-slate-700">
        ...
        <section className="mb-20">
          ...
          <div className="relative">
            ...
            {[{
              ...
              <div key={i} className={`mb-8 flex justify-center items-center w-full ${i === 2 ? 'mb-0' : ''}`}>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {[
              ...
              <div key={i} className="bg-slate-800 p-6 rounded-xl shadow-lg border border-slate-700 flex flex-col justify-between">
