      ...
      <div className="max-w-5xl mx-auto p-4 sm:p-8">
        ...
        <header className="flex justify-between items-center mb-8">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-2xl font-bold text-white">Inova AI Solutions</span>
          </div>
        </header>
        ...
        {/* Solution Section */}
        <section className="mb-16 bg-slate-800/50 rounded-2xl p-8 shadow-2xl border border-slate-700">
          ...
          <div className="mt-10 bg-slate-700/50 p-6 rounded-lg text-center border border-slate-600">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {[
              ...
              <div key={idx} className={`bg-slate-800 p-6 rounded-xl shadow-lg border-t-4 ${kpi.border} text-center`}>
        ...
        {/* Testimonial Section */}
        <section className="mb-16 bg-blue-900/70 text-white rounded-2xl p-8 md:p-12 shadow-2xl border border-blue-800">
          <div className="flex flex-col md:flex-row items-center text-center md:text-left">
            {/* You can use next/image or plain img here */}
            <img
              src="https://placehold.co/100x100/1e293b/94a3b8?text=DF"
              alt="Dr. Finch"
              className="w-24 h-24 rounded-full mb-6 md:mb-0 md:mr-8 flex-shrink-0 border-4 border-blue-700"
            />
            <div>
              ...
              <p className="mt-4 font-bold text-blue-300">— Dr. Finch, Chief Medical Officer</p>
            </div>
          </div>
        </section>
        ...
        <footer className="text-center py-8 border-t border-slate-800">
          ...
          <h3 className="text-2xl md:text-3xl font-bold text-white">
            Ready to Humanize Healthcare at Your Organization?
          </h3>
          <p className="mt-3 mb-6 text-slate-400 max-w-2xl mx-auto">
            See how Inova AI's intelligent agents can reduce costs, empower your staff, and transform the patient experience.
          </p>
          <a href="/book-a-consultation" className="inline-block bg-blue-600 text-white font-bold py-3 px-8 rounded-lg hover:bg-blue-500 transition-colors shadow-lg">
            Schedule a Demo Today
          </a>
          <div className="mt-8 text-sm text-slate-500">
            <span>🌐 www.InovaSolutions.ai</span>
            <span className="mx-2">|</span>
            <span>📧 sales@inovasolutions.ai</span>
            <span className="mx-2">|</span>
            <span>📞 Dubai +971 54 220 29 77 | 📞 Sydney +61 49 331 0 331</span>
          </div>
        </footer>
      </div>
      <MegaFooter/>
