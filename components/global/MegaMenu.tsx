    ...
    columns: [
      {
        title: "Core Services",
        content: [
          { text: "AI Transformation", caption: "Strategic consulting to reshape your business.", href: "/why-inova#differentiators", icon: "abstract-idea-spark" },
          { text: "Custom AI Development", caption: "Bespoke solutions for unique challenges.", href: "/solutions-by-industry", icon: "abstract-gears" },
          { text: "AI Orchestration", caption: "Seamlessly integrate and manage AI models.", href: "/bldr-platform#developer-access", icon: "abstract-nodes" }
        ]
      },
      {
        ...
        content: [
          ...
          { text: "Sovereign AI", caption: "Full data control, on-premise or private cloud.", href: "/why-inova#data-sovereignty", icon: "abstract-shield" },
          { text: "Developer Access", caption: "APIs and SDKs for unlimited customization.", href: "/bldr-platform#developer-access", icon: "abstract-code" }
        ]
      }
    ]
  }
  ...
  const solutionsMenu = {
    columns: [
      ...
      },
      {
        title: "By Use Case",
        content: [
          { text: "Customer Service", href: "/solutions-by-industry#customer-service", icon: "icon-support" },
          { text: "Marketing & Agencies", href: "/solutions-by-industry#agencies", icon: "icon-marketing" },
          { text: "Sales Automation", href: "/bldr-platform#use-cases", icon: "icon-sales" },
          { text: "Operations", href: "/bldr-platform#use-cases", icon: "icon-operations" }
        ]
      },
      {
        title: "Featured Content",
        featuredCard: {
          imageSrc: "/images/megamenu/case-study-thumb.png",
          headline: "Case Study: Telecom Leader Boosts CSAT by 40%",
          description: "Discover how our AI agents transformed their support.",
          cta: { text: "Read Now", href: "/resources#case-studies" }
        }
      } as any
    ]
  }
    ...
    columns: [
      {
        ...
        content: [
          { text: "Our Approach", caption: "How we architect AI differently.", href: "/why-inova", icon: "abstract-compass" },
          { text: "Data Sovereignty", caption: "Your data, your rules. Always.", href: "/why-inova#data-sovereignty", icon: "abstract-shield" },
          { text: "Responsible AI", caption: "Ethical, transparent, and compliant.", href: "/why-inova#responsible-ai", icon: "abstract-scales" }
        ]
      },
      {
        title: "About Us",
        content: [
          { text: "Our Team", caption: "Meet the minds behind the mission.", href: "/our-team", icon: "icon-team" },
          { text: "Partners", caption: "Join our growing ecosystem.", href: "/partner-with-inova", icon: "icon-handshake" },
          { text: "Careers", caption: "Build the future with us.", href: "/careers", icon: "icon-rocket" }
        ]
      }
    ]
  }
            ...
            <div key={index}>
              ...
              {(column as any).featuredCard ? (
                <div className="surface-card p-4">
                  <div className="aspect-video bg-backgroundDark rounded-lg mb-4 flex items-center justify-center">
                    <span className="text-textSecondary text-sm">Case Study Image</span>
                  </div>
