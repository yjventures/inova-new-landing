...
const ConsultationHeroSection = () => {
  ...
  return (
    <section className="py-12 bg-backgroundDark min-h-screen flex items-center">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Right Column - Will be the form (handled in parent component) */}
          <div className="lg:block hidden">
            {/* This space will be filled by the form component */}
          </div>
        </div>
      </div>
    </section>
