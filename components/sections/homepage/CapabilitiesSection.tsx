  ...
  const capabilities = [
    {
      ...
      description: "Strategic consulting and implementation to reshape your business with AI.",
      cta: { text: "Learn More", href: "/why-inova#differentiators" },
      icon: Lightbulb,
      visual: "/images/icons/icon-transformation.jpg"
    },
    {
      title: "Custom AI Development",
      description: "Bespoke AI models and solutions tailored to your unique challenges.",
      cta: { text: "Learn More", href: "/solutions-by-industry" },
      icon: Settings,
      visual: "/images/icons/icon-custom-dev.jpg"
    },
    {
      title: "BLDR Platform",
      description: "No-code AI agent creation, orchestration, and automation.",
      cta: { text: "Learn More", href: "/bldr-platform" },
      icon: Layers,
      visual: "/images/icons/icon-bldr.jpg"
    }
  ]
          ...
          {capabilities.map((capability, index) => {
            ...
            return (
              <motion.div
                ...
                className="group"
              >
                <Card className="h-full border-borderSubtle hover:border-accentPurple/50 transition-all duration-300 relative overflow-hidden">
                  ...
                  <CardFooter className="p-8 pt-0">
                    <Button
                      variant="ghost"
                      className="group/btn w-full justify-between p-0 h-auto text-accentPurple hover:text-white font-semibold"
                      asChild
                    >
                      <Link href={capability.cta.href}>
